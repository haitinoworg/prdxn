...
function parallax_homepage_widgets() {
	...
	genesis_widget_area( 'home-section-4', array(
		...
		. '<div class="pricing-table"><div class="one-third first"><h4>Basic - $95</h4><a class="button" href="#">Purchase</a></div><div class="one-third"><h4>Professional - $150</h4><a class="button" href="#">Purchase</a></div><div class="one-third"><h4>Advanced - $350</h4><a class="button" href="#">Purchase</a></div></div></div>',
		'after'  => '</div></div>',
		) );
